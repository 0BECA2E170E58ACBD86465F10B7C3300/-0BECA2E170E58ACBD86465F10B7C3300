...
attributes for account number, accout holder name, and account balance. Include mathods to 
deposite money, withdraw money , and display the account balance.Ensure that the account balance 
cannot be accessed dirctly fromoutside the class.Write a program to create an instance of the 
...
class BankAccount:
  ...
  def deposite(self, amount):
    if amount >0:
      ...
      print("Invalied deposite amount.")
